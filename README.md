...
compatible GeoServer series: `3.0-SNAPSHOT` is the development build for
GeoServer 3.0, and releases number the series independently (`3.0-1`, `3.0-2`,
...) because the plugins may release more than once against one GeoServer
series. The `main` branch does the same for GeoServer 3.1.
