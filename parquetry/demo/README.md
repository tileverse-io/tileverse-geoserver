...
The `Makefile` is one level up, in the `parquetry` module directory. From there:
...
- `make plugin` runs `./mvnw -pl :tileverse-geoserver-parquetry -Passembly package`, producing the standard
